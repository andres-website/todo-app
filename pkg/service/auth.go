...
const (
	salt       = "lkjl3lkjpjh3kjbh3lkj3lkje"
...
func (s *AuthService) GentrateToken(username, password string) (string, error) {
...
func (s *AuthService) ParseToken(accessToken string) (int, error) {
	...
	if !ok {
		return 0, errors.New("token claims are note of type *tokenClaims")
	}
